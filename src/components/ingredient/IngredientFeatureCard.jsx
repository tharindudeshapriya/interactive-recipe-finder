...
const IngredientFeatureCard = ({ data, onAction, loading }) => {
    if (loading) {
        return <div className="h-[400px] bg-neutral-light/5 animate-pulse rounded-3xl border border-neutral-light/10" />;
    }
    ...
    return (
        <div className="relative group overflow-hidden rounded-3xl bg-neutral-light/5 border border-neutral-light/10 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 transition-all duration-500 hover:shadow-xl hover:bg-neutral-light/10 h-full">
            <div className="flex-1 text-center md:text-left order-2 md:order-1">
                <span className="inline-block text-[10px] font-bold uppercase tracking-[0.3em] text-primary mb-3">Discovery</span>
                ...
                <p className="text-neutral-dark font-light leading-relaxed mb-6 line-clamp-2 md:line-clamp-3 text-sm italic">{description}</p>
