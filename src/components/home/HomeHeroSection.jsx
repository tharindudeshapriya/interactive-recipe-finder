        ...
        <section className={`relative transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] ${isShowingInspiration ? 'py-12 md:py-32' : 'py-6 md:py-16'}`}>
            ...
            <div className="relative z-[70] w-full h-full flex flex-col items-center justify-center pt-8">
                <div className="px-6 text-center max-w-4xl mx-auto w-full">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-4 md:mb-8">
                        <div className={`bg-primary rounded-2xl shadow-xl shadow-primary/20 rotate-[-3deg] flex items-center justify-center transition-all duration-700 ${isShowingInspiration ? 'p-3 sm:p-4' : 'p-2 sm:p-3'}`}>
                            <svg className={`text-white transition-all duration-700 ${isShowingInspiration ? 'w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16' : 'w-8 h-8 md:w-10 md:h-10'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 className={`font-serif text-text-base tracking-tight transition-all duration-700 ${isShowingInspiration ? 'text-4xl sm:text-5xl md:text-7xl' : 'text-2xl md:text-4xl'} m-0 shrink-0`}>
